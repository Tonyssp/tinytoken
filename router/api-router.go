...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/user/leaderboard", controller.GetPublicUserLeaderboard)
		...
		apiRouter.POST("/payment/other/telegram/webhook", controller.OtherPaymentTelegramWebhook)
		apiRouter.POST("/payment/other/line/webhook", controller.OtherPaymentLineWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/topup/promptpay", middleware.CriticalRateLimit(), controller.RequestPromptPayTopUp)
				selfRoute.POST("/topup/other", middleware.CriticalRateLimit(), controller.RequestOtherPaymentTopUp)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/leaderboard/candidates", controller.GetUserLeaderboardCandidates)
